        ...
        "random":
            {
              ...
              "railcar":f"INSERT INTO railcar (parametrs) SELECT chr(trunc(65+random()*25)::int), timestamp '1970-01-10 20:00:00'+ random() * (timestamp '2033-01-20 20:00:00' - timestamp '1970-01-10 10:00:00'),id_train From train order by random() limit 1",
              "ticket":f"INSERT INTO ticket (parametrs) SELECT trunc(random()*1000)::int,trunc(random()*1000)::int,chr(trunc(65+random()*25)::int),id_railcar FROM railcar order by random() limit 1"
            },
        "delete":"delete FROM table_name WHERE str_of_based_column",
        "add_inf":"INSERT INTO table_name (parametrs) VALUES (values)",
        "upd_inf":f"UPDATE table_name SET str_of_updating_column WHERE str_of_based_column;",
